DungeonGuide_Guides["dung-halls-of-atonement-tww-s3"] = {
  ...
  ["Halls of Atonement"] = {
    ...
    entries = {
      ...
      { order = 4, role = "ALL", text = "Kick priorities: s[Siphon Life] (n[Depraved Collector]) > s[Wicked Bolt] (n[Depraved Obliterator]) and stop n[Depraved Houndmaster] s[Loyal Beast].", type = "Interrupt", id = "gui-uDRzyUbbFh4" },
      { order = 5, role = "TANK", text = "n[Vicious Gargon] applies bleed. Focus n[Depraved Houndmaster] first; nearby Gargons take less damage and can be enraged by s[Loyal Beast].", type = "Position", id = "gui-jdVlzP97hrU" },
  ...
  ["Route"] = {
    ...
    entries = {
      ...
      { order = 3,  role = "ALL", text = "Control n[Toiling Groundskeeper] flee behaviour to avoid extra packs.", target = "Toiling Groundskeeper", type = "Target", id = "gui-iIeUZbv0hA" },
      ...
      { order = 7,  role = "ALL", text = "Head right up stairs. Manage tight patrol spacing; beware n[Reaver] s[Mortal Strike] and n[Eviscerator] s[Hurl Glaive] bounces.", target = "Stoneborn Reaver", type = "Target", id = "gui-DzQxjPyJMc" },
      ...
      { order = 10, role = "ALL", text = "After Echelon, clear right-side patrols before cathedral. Prioritise n[Depraved Houndmaster] and n[Stoneborn Reaver].", target = "Depraved Houndmaster", type = "Target", id = "gui-99cd6V1IKcM" },
