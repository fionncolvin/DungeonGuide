DungeonGuide_Guides["dung-tazavesh-streets-tww-s3"] = {
  ...
  ["Route"] = {
    ...
    header = "Route",
    entries = {
      { order = 1, role = "ALL", text = "We are pulling opener: n[Custom Security] + n[Gatewarden Zo'm]. Purge s[Hard Light Baton] and dodge s[Disruption Grenade].", type = "Call", id = "gui-gAEZJu5VO2U" },
      { order = 2, role = "ALL", text = "Interrupt n[Gatewarden Zo'm] s[Proxy Strike] when possible, else tank must defensively handle it.", type = "Call", id = "gui-N2bUAsqHBXg" },
      { order = 3, role = "ALL", text = "CC and kill n[Gatewarden Zo'm] quickly to reduce s[Proxy Strike] tank pressure.", type = "Target", target = "Gatewarden Zo'm", id = "gui-P04phuJe6PA" },
      { order = 4, role = "ALL", text = "Clear stairs to n[Portalmancer Zo'han]. Prioritise interrupts on s[Empowered Glyph of Restraint] and s[Glyph of Restraint] from adds.", type = "Call", id = "gui-8ZpYQu0hDH4" },
      { order = 5, role = "ALL", text = "CC and kill n[Portalmancer Zo'han] fast to stop s[Empowered Glyph of Restraint] group CC.", type = "Target", target = "Portalmancer Zo'han", id = "gui-UoqIwT5hMcQ" },
      { order = 6, role = "ALL", text = "Kill n[Portalmancer Zo'han] to spawn n[Zo'phex the Sentinel].", type = "Jump", id = "gui-hjwUXCzYM7s", target = "Zo'phex the Sentinel" },
      { order = 7, role = "ALL", text = "After n[Zo'phex], go RIGHT for Mailroom → Oasis route. LEFT leads to n[Grand Menagerie].", type = "Call", id = "gui-RNUERHfIJEM" },
      { order = 8, role = "ALL", text = "Right path trash: watch for stealth n[Cartel Skulker] bleeds, dispel s[Hyperlight Bomb], soothe n[Cartel Muscle] enrages, and kick s[Hyperlight Bolt].", type = "Call", id = "gui-QcY86pOnE4E" },
      { order = 9, role = "ALL", text = "Clear into mailroom. Interrupt/purge n[Overloaded Mailmental] s[Spam Filter], tank manage s[Letter Opener] bleed, and dodge swirlies from n[Cartel Smuggler].", type = "Call", id = "gui-WfW4pTMZ5pY" },
      { order = 10, role = "ALL", text = "Kill n[Overloaded Mailmental] first to avoid s[Spam Filter] silences.", type = "Target", target = "Overloaded Mailmental", id = "gui-wT4bdg2bl9c" },
      { order = 11, role = "ALL", text = "Kill trash to engage n[P.O.S.T. Master].", type = "Jump", id = "gui-Xa57Wauc9As", target = "P.O.S.T. Master" },
      { order = 12, role = "ALL", text = "After mailroom, return to Bazaar for vendor RP. Tank carries items to control n[Bizarre Strongarm] fixates.", type = "Call", id = "gui-cwV0ON8F5Vg" },
      { order = 13, role = "ALL", text = "Final wave before Oasis includes n[Bizarre Overseer] and n[Bizarre Strongarm] — use defensives for high tank damage.", type = "Call", id = "gui-ODUa32tybSE" },
      { order = 14, role = "ALL", text = "Enter Oasis and clear RP event waves to unlock n[Zo'gron].", type = "Jump", id = "gui-O5uQHi3tgqE", target = "Zo'gron" },
      { order = 15, role = "ALL", text = "Left path from n[Zo'phex]: n[Tracker Zo'korss] mini-boss — bait s[Beam Splicer] and dispel s[Lockdown] root.", type = "Call", id = "gui-mtIbJfCXfPI" },
      { order = 16, role = "ALL", text = "Kill paired n[Ancient Core Hound] within seconds, interrupt s[Ancient Dread], dodge n[Enraged Direhorn] charge.", type = "Call", id = "gui-DffVzyZwuJk" },
      { order = 17, role = "ALL", text = "Focus n[Ancient Core Hound] pair to avoid overlapping s[Ancient Dread].", type = "Target", target = "Ancient Core Hound", id = "gui-rK9Disl28g" },
      { order = 18, role = "ALL", text = "Clear to n[Grand Menagerie].", type = "Jump", id = "gui-zZCkUFyUUNI", target = "Grand Menagerie" },
      { order = 19, role = "ALL", text = "After Menagerie, cross central market. Interrupt n[Veteran Sparkcaster] and stop n[Market Peacekeeper] s[Fail-Safe Field].", type = "Call", id = "gui-fHlpVLZNW7A" },
      { order = 20, role = "ALL", text = "Kill n[Market Peacekeeper] before s[Fail-Safe Field] finishes to prevent DR shield.", type = "Target", target = "Market Peacekeeper", id = "gui-c08X8i6QAdM" },
      { order = 21, role = "ALL", text = "Final mini-boss before n[So'azmi] casts s[Shock Mine] and s[Lethal Force] tether — spread to avoid overlap.", type = "Call", id = "gui-tC8KPj0wTz4" },
      { order = 22, role = "ALL", text = "Kill to engage n[So'azmi].", type = "Jump", id = "gui-RAegCrvVPY4", target = "So'azmi" }
    }
  },
