DungeonGuide_Guides["dung-tazavesh-streets-tww-s3"] = {
  ...
  ["Tazavesh: Streets of Wonder"] = {
    ...
    entries = {
      ...
      { order = 3, role = "ALL", text = "Defeat n[Portalmancer Zo'han] to spawn first boss n[Zo'phex the Sentinel].", type = "Call", id = "gui-6Xxq3o2m" },
  ...
  ["Route"] = {
    ...
    entries = {
      ...
      { order = 3, role = "ALL", text = "Clear stairs to n[Portalmancer Zo'han]. Prioritise interrupts on s[Empowered Glyph of Restraint].", type = "Call", id = "gui-X6uLR8Wz" },
      { order = 4, role = "ALL", text = "Kill n[Portalmancer Zo'han] to spawn n[Zo'phex the Sentinel].", type = "Jump", id = "gui-R8wTmAYz", target = "Zo'phex the Sentinel" },
      { order = 5, role = "ALL", text = "After n[Zo'phex], go RIGHT for Mailroom → Oasis route. LEFT leads to n[Grand Menagerie].", type = "Call", id = "gui-aF1XSpwB" },
      { order = 6, role = "ALL", text = "Right path trash: watch for stealth n[Cartel Skulker] bleeds, dispel s[Hyperlight Bomb], soothe n[Cartel Muscle] enrages.", type = "Call", id = "gui-4vESlWx8" },
      { order = 7, role = "ALL", text = "Clear into mailroom. Interrupt/purge n[Overloaded Mailmental] s[Spam Filter], tank manage s[Letter Opener] bleed.", type = "Call", id = "gui-rZqK7ph3" },
      { order = 8, role = "ALL", text = "Kill trash to engage n[P.O.S.T. Master].", type = "Jump", id = "gui-5p7btVmY", target = "P.O.S.T. Master" },
      { order = 9, role = "ALL", text = "After mailroom, return to Bazaar for vendor RP. Tank carries items to control n[Bizarre Strongarm] fixates.", type = "Call", id = "gui-dMf4gUSc" },
      { order = 10, role = "ALL", text = "Final wave before Oasis includes n[Bizarre Overseer] and n[Bizarre Strongarm] — use defensives for high tank damage.", type = "Call", id = "gui-YWpEobn4" },
      { order = 11, role = "ALL", text = "Enter Oasis and clear RP event waves to unlock n[Zo'gron].", type = "Jump", id = "gui-jxF1E7KR", target = "Zo'gron" },
      { order = 12, role = "ALL", text = "Left path from n[Zo'phex]: n[Tracker Zokor] mini-boss — bait s[Beam Splicer], dispel s[Lockdown] root.", type = "Call", id = "gui-aVfZbgRX" },
      { order = 13, role = "ALL", text = "Kill paired n[Ancient Core Hound] within seconds, interrupt s[Ancient Dread], dodge n[Enraged Direhorn] charge.", type = "Call", id = "gui-3eZ4rph9" },
      { order = 14, role = "ALL", text = "Clear to n[Grand Menagerie].", type = "Jump", id = "gui-hQ5Mt4g1", target = "Grand Menagerie" },
      { order = 15, role = "ALL", text = "After Menagerie, cross central market. Interrupt n[Veteran Sparkcaster] and stop n[Market Peacekeeper] s[Fail-Safe Field].", type = "Call", id = "gui-Ym3s4gFq" },
      { order = 16, role = "ALL", text = "Final mini-boss before n[So'azmi] casts s[Shock Mine] and s[Lethal Force] tether — spread to avoid overlap.", type = "Call", id = "gui-XRJyfmGe" },
      { order = 17, role = "ALL", text = "Kill to engage n[So'azmi].", type = "Jump", id = "gui-km4xYPqV", target = "So'azmi" }
    }
  },
