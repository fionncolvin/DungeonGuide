DungeonGuide_Guides["dung-priory-tww-s3"] = {
  ...
  ["Route"] = {
    ...
    header = "Route",
    entries = {
      { order = 1, role = "ALL", text = "We are taking the RIGHT side - n[Arathi Footman] + n[Fervent Sharpshooter] packs give high count with lower danger.", type = "Call", id = "gui-crl2XyqOM9U" },
      { order = 2, role = "ALL", text = "CC and kill n[Arathi Footman] fast to stop s[Defend] damage reduction.", type = "Target", target = "Arathi Footman", id = "gui-6HRR0XjsYg" },
      { order = 3, role = "ALL", text = "Pull opener into n[Guard Captain Sullean]. I'll tank him near stairs/wall to negate knockback.", type = "Call", id = "gui-HngNrqrbL7o" },
      { order = 4, role = "ALL", text = "After Sullean, engage n[Sergeant Shaynemail] - spread for s[Lunging Strike] bleed or stand on brazier to avoid target.", type = "Call", id = "gui-s68cyWog7gI" },
      { order = 5, role = "ALL", text = "Chain into n[Fervent Sharpshooter] + n[Arathi Footman] patrol. Ranged stack in melee to bait s[Disengage].", type = "Call", id = "gui-3YZuCMDULA" },
      { order = 6, role = "ALL", text = "Next up: n[Forge Master Damian]. Dodge puddles, use AMS/Bubble/Spellwarding to prevent spawns.", type = "Call", id = "gui-mME4zE56BUU" },
      { order = 7, role = "ALL", text = "Move to fountain area, clear patrol into n[Elaena Emberlanz]. Interrupt s[Holy Radiance], dispel tank after s[Divine Judgment].", type = "Call", id = "gui-3VdrlNkqpA8" },
      { order = 8, role = "ALL", text = "Boss: n[Captain Dailcry] with 1 lieutenant. Stack, cleave, manage puddle placement.", type = "Jump", target = "Captain Dailcry", id = "gui-8XkbvCauXq8" },
      { order = 9, role = "ALL", text = "After boss, clear to cathedral. Skip LEFT side if we have count. Watch n[Ardent Paladin] s[Sacred Toll] and n[Zealous Templar] buffs.", type = "Call", id = "gui-or58bolGGlw" },
      { order = 10, role = "ALL", text = "Kill n[Ardent Paladin] fast to reduce s[Sacred Toll] group hits.", type = "Target", target = "Ardent Paladin", id = "gui-xISpKCP8YBc" },
      { order = 11, role = "ALL", text = "Interrupt n[Devout Priest] s[Greater Heal] and n[Risen Mage] s[Fireball Volley]. Stun n[Lightspawn] at low HP to avoid Purification heal.", type = "Call", id = "gui-f2V9TKEHg" },
      { order = 12, role = "ALL", text = "Focus n[Devout Priest] to prevent s[Greater Heal] and n[Risen Mage] to stop s[Fireball Volley].", type = "Target", target = "Devout Priest", id = "gui-t3FklRBmQ3Y" },
      { order = 13, role = "ALL", text = "Next: n[Baron Braunpyke]. Hug left wall to bait hammers into one zone.", type = "Jump", target = "Baron Braunpyke", id = "gui-DsqWRk2yRRU" },
      { order = 14, role = "ALL", text = "Stairwell pack after Baron - LOS pull around corner. Handle n[Lightspawn] separately to avoid heals.", type = "Call", id = "gui-lTjuyGEF1tc" },
      { order = 15, role = "ALL", text = "Final mini-boss: n[Baron Braunpyke]. Use Bloodlust here if not saving for last boss.", type = "Call", id = "gui-N9rU8D95PBo" },
      { order = 16, role = "ALL", text = "Last boss: n[Prioress Murrpray]. Prep cooldowns for 50% add phase and s[Embrace the Light] shield burn.", type = "Jump", target = "Prioress Murrpray", id = "gui-gmhzF4kXzek" }
    }
  },
