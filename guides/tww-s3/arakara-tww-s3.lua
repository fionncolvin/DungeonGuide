DungeonGuide_Guides["dung-ara-kara-tww-s3"] = {
  ...
  ["Route"] = {
    ...
    entries = {
      ...
      { order = 5,  role = "ALL", text = "Mini-Boss-2: n[Nakt].", type = "Jump", target = "Nakt", id = "gui-yOGOjYwjuGw" },
      { order = 8,  role = "ALL", text = "We then rotate to the right-side platform for n[Atik]. Watch for s[Poisonous Cloud] and bad positioning.", type = "Call", id = "gui-kVfzgB5UZiY" },
      { order = 5,  role = "ALL", text = "Mini-Boss-3: n[Atik].", type = "Jump", target = "Atik", id = "gui-yOGOjYwjuGw" },
      { order = 9,  role = "ALL", text = "Back for n[Avanoxx] jumps in. Hold defensives for s[Alerting Shrill] and control Starved Crawlers.", type = "Call", id = "gui-BmE3npAja4k" },
      { order = 9,  role = "ALL", text = "Boss-1: n[Avanoxx]", type = "Jump", id = "gui-BmE3npAja4k", target = "Avanoxx" },
      { order = 10, role = "ALL", text = "Cross bridge and prep interrupts on n[Bloodstained Webmage] (s[Revolting Volley]), n[Bloodstained Webmage] (s[Web Bolt]), n[Sentry Stagshell] (s[Alarm Shrill]).", type = "Call", id = "gui-X36zpmQKV0" },
      { order = 11, role = "ALL", text = "CC and Kill n[Sentry Stagshell] before it casts s[Alarm Shrill].", target = "Sentry Stagshell", type = "Target", id = "gui-Z63xdrQKV0" },
      { order = 12, role = "ALL", text = "Kick n[Bloodstained Webmage] - stop s[Revolting Volley] first, then s[Web Bolt].", target = "Bloodstained Webmage", type = "Target", id = "gui-r9Wb6nJtYF" },
      { order = 13, role = "ALL", text = "Kill n[Hulking Bloodguard] first to remove Bulwark; interrupt/CC s[Locust Swarm].", target = "Hulking Bloodguard", type = "Target", id = "gui-2KpZbq0cNM" },
      { order = 14, role = "ALL", text = "Boss-2: n[Anub'zekt].", type = "Target", target = "Anub'zekt", id = "gui-G06c4JTfg2A" },
      { order = 15, role = "ALL", text = "Final trash wing includes n[Blood Overseer] (kick s[Venom Volley]) and n[Reinforced Drone] (dispel magic slow/heal reduction).", type = "Call", id = "gui-I0jRRtfrayQ" },
      { order = 16, role = "ALL", text = "Tank tags n[Winged Carrier] first — they leap to the first target in range. Use grips/knockbacks if needed.", target = "Winged Carrier", type = "Target", id = "gui-LmizXz6ZcdE" },
      { order = 17, role = "ALL", text = "Boss-3: n[Ki'katal the Harvester].", type = "Jump", target = "Ki'katal the Harvester", id = "gui-by0XVCpgtLc" }
    }
  },
