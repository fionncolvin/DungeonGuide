DungeonGuide_Guides["dung-ecodome-tww-s3"] = {
  ...
  ["Route"] = {
    ...
    header = "Route",
    entries = {
      { order = 1, role = "ALL", type = "Call", id = "gui-H3cMKEfYPOg", text = "We will start by turning left and hugging the wall to skip the opening patrols." },
      { order = 2, role = "ALL", type = "Call", id = "gui-2Iq05fQ2U", text = "We use Bloodlust on the big opener down the stairs. All cooldowns here." },
      { order = 3, role = "ALL", type = "Target", id = "gui-0t3F90dMys4", target = "Ravenous Destroyer", text = "We kill n[Ravenous Destroyer] first. Spread for s[Gluttonous Miasma] and dodge s[Volatile Ejection]." },
      { order = 4, role = "ALL", type = "Target", id = "gui-xjCb58TJE", target = "Overgorged Mite", text = "Interrupt s[Engorge]. It stacks and explodes on death. Use 2 melee in rotation." },
      { order = 5, role = "ALL", type = "Call", id = "gui-N0rlZD9UaIs", text = "Next, we continue pulling upstairs into two more n[Ravenous Destroyer]s. Defensives here." },
      { order = 6, role = "ALL", type = "Call", id = "gui-cH3PouK9nIQ", text = "We will drag the two Scavengers into Boss-1 for funnel damage." },
      { order = 7, role = "ALL", type = "Jump", id = "gui-43AcvTPZLyk", target = "Azhiccar", text = "Boss-1 - Azhiccar" },
      { order = 8, role = "ALL", type = "Call", id = "gui-4t174MNpILA", text = "After boss, we pull carefully. Only one n[Overcharged Sentinel] at a time." },
      { order = 9, role = "ALL", type = "Target", id = "gui-2TOjjHpANnM", target = "Overcharged Sentinel", text = "When shield breaks, they cast s[Unstable Core]. Kite from puddles." },
      { order = 10, role = "ALL", type = "Target", id = "gui-jy0wGgmxw", target = "Wastelander Farstalker", text = "Kick s[Arcing Zap]. One ranged kick is enough." },
      { order = 11, role = "ALL", type = "Target", id = "gui-bAAzFJRL0", target = "Wastelander Ritualist", text = "Use 2 melee to rotate kicks on s[Arcane Bolt]." },
      { order = 12, role = "ALL", type = "Call", id = "gui-DUtXnGb6ukg", text = "We move uphill for another Sentinel with Ritualist and Farstalker. Same plan." },
      { order = 13, role = "ALL", type = "Call", id = "gui-d8pPg11Tptk", text = "Clear toward the arena, ending with Ritualist pack before Boss-2." },
      { order = 14, role = "ALL", type = "Jump", id = "gui-EcDI2aGYtwk", target = "Taah'bat", text = "Boss-2 - Taah'bat and A'wazj" },
      { order = 15, role = "ALL", type = "Call", id = "gui-cNufnxZK1ZU", text = "Leaving boss, we hug the right cliff to skip the first n[Wastelander Pactspeaker]. Stay tight." },
      { order = 16, role = "ALL", type = "Target", id = "gui-k7ngGfNwnYg", target = "Wastelander Pactspeaker", text = "Kick s[Arcane Bolt]. Swap fast to the spawned spirit from s[Consume Spirit]." },
      { order = 17, role = "ALL", type = "Target", id = "gui-gaoss9GJHJs", target = "Wastes Creeper", text = "Tank beware: s[Gloom Bite] is a heavy hit with healing absorb." },
      { order = 18, role = "ALL", type = "Call", id = "gui-tSECCVXFZIQ", text = "We use manageable pulls for count, mixing in Phaseblades and Ruinstalkers." },
      { order = 19, role = "ALL", type = "Call", id = "gui-qqXP0fT4ZM", text = "We finish count on smaller packs before the final boss." },
      { order = 20, role = "ALL", type = "Call", id = "gui-EBtrtniTt0I", text = "Use Arcane Siphons near the path for a haste and speed buff if they are on route." },
      { order = 21, role = "ALL", type = "Jump", id = "gui-B4ePGrTRMkY", target = "Soul-Scribe", text = "Boss-3 - Soul-Scribe" }
    }
  },
