DungeonGuide_Guides["Cinderbrew Meadery"] = {
  ...
  ["Cinderbrew Meadery"] = {
    ...
    entries = {
      ...
      { order = 2, role = "ALL", text = "s:Sticky Honey: (Cooking/Alchemy 25+): AoE slow + haste debuff â€” affects allies too.", type = "Mechanic", id = "gui-S9Z39Og" },
      { order = 3, role = "ALL", text = "s:Flamethrower: (Eng/Gnome/Goblin 25+): Low AoE damage â€” best used by healers.", type = "Mechanic", id = "gui-Zwb3cLcp68M" },
      { order = 4, role = "ALL", text = "Watch for Thirsty enrages â€” mobs gain haste and damage.", type = "Mechanic", id = "gui-P3ESu4qPHg" },
      { order = 5, role = "ALL", text = "Heavy use of swirlies, AoE zones, and frontal attacks â€” constant movement needed.", type = "Mechanic", id = "gui-0wilnaHqoI" },
      ...
      { order = 7, role = "ALL", text = "Frequent magic debuffs â€” s:Burning Fermentation:, s:Bee Venom:, s:Erupting Inferno:.", type = "Mechanic", id = "gui-4wUjYl9w2o" },
      ...
      { order = 10, role = "TANK", text = "Stagger Bee packs â€” s:Final Sting: and s:Swarming Surprise: can chain kill tanks.", type = "Mechanic", id = "gui-PNdUSfm0rps" },
      ...
      { order = 12, role = "HEALER", text = "s:Flamethrower: is safe utility â€” avoid during heavy group damage.", type = "Mechanic", id = "gui-Ns0qoZ2A" },
      ...
      { order = 15, role = "DPS", text = "Use CC on n:Brew Drops: and Bees â€” prevent them reaching boss/barrels.", type = "Mechanic", id = "gui-IELGyq8w9ss" }
    },
  },
  ...
  ["Brew Master Aldryr"] = {
    ...
    entries = {
      ...
      { order = 4, role = "TANK", text = "Kite boss during brawler phase â€” avoid stuns.", type = "Position", id = "gui-xtEio9eZ0hM" },
      ...
      { order = 9, role = "HEALER", text = "s:Throw Cinderbrew: on 2 players. Iâ€™ll spot heal or use CDs.", type = "Call", id = "gui-AmwGQ4cHuh8" },
  ...
  ["I'pa"] = {
    ...
    header = "Boss: I'pa",
    entries = {
      { order = 1, role = "ALL", text = "s:Spouting Stout: incoming â€” dodge swirls!", type = "Call", id = "gui-GFDl9bLOkjE" },
      { order = 2, role = "ALL", text = "n:Brew Drops: spawning â€” CC + burn before they reach boss.", type = "Call", id = "gui-HReiAAZfZc0" },
      { order = 3, role = "TANK", text = "Move boss to opposite wall on s:Spouting Stout:.", type = "Mechanic", id = "gui-KZygOAERT0" },
      { order = 4, role = "TANK", text = "Keep boss off puddles â€” avoid tank knockbacks.", type = "Mechanic", id = "gui-1GKEfn8kw0c" },
      { order = 5, role = "TANK", text = "Moving boss â€” avoid puddles + handle adds.", type = "Call", id = "gui-aDduXN9jRZk" },
      { order = 6, role = "TANK", text = "Stun/knock s:Brew Drops: before Fill 'Er Up.", type = "Mechanic", id = "gui-sQ1Gcv8OlIk" },
      { order = 7, role = "TANK", text = "Watch s:Uppercut: â€” don't get knocked into puddles or adds.", type = "Mechanic", id = "gui-nhzdzzpNyUc" },
  ...
  ["Benk Buzzbee"] = {
    ...
    entries = {
      ...
      { order = 2, role = "ALL", text = "Avoid s:Honey Marinade: puddles â€” they buff adds.", type = "Mechanic", id = "gui-xzvDbrpvno" },
      { order = 3, role = "TANK", text = "Use major on s:Honey Marinade:. Drop puddle near wall.", type = "Mechanic", id = "gui-ShFlvbqoFBM" },
      { order = 4, role = "TANK", type = "Mechanic", text = "s:Honey Marinade: placement is criticalâ€”use wall edge if possible." , id = "gui-rLSgXb81E" },
      { order = 5, role = "TANK", type = "Call", text = "Dropping marinade far. Keep bees away from puddle." , id = "gui-nGxPgTVfjE" },
      { order = 6, role = "TANK", type = "Mechanic", text = "Pick up threat on spawned n:Cinderbees: ASAPâ€”assign kick focus if needed." , id = "gui-2xVIu1IRMW8" },
      { order = 7, role = "TANK", type = "Mechanic", text = "Avoid using Bee-Haw yourself â€” assign DPS to handle barrels." , id = "gui-LudygrSb7rs" },
  ...
  ["Goldie Baronbottom"] = {
    ...
    entries = {
      ...
      { order = 8, role = "TANK", type = "Mechanic", text = "Use frontal to manage barrel controlâ€”avoid clipping allies." , id = "gui-1VmtrxI8vs" },
