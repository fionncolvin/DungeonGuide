DungeonGuide_Guides["Darkflame Cleft"] = {
  ...
  ["Route"] = {
    ...
    entries = {
      ...
      { role = "ALL", text = "Boss Fight: Ol' Waxbeard", type = "Jump", target="Ol' Waxbeard" , id = "gui-eWPyTXqq0bE" },
      ...
      { role = "ALL", text = "Boss Fight: Blazikon", type = "Jump", target="Blazikon" , id = "gui-heRvcHJWo8M" },
      ...
      { role = "ALL", text = "Boss Fight: The Candle King", type = "Jump", target="The Candle King" , id = "gui-HoWaQEjX2hs" },
      ...
      { role = "ALL", text = "Boss Fight: The Darkness", type = "Jump", target="The Darkness" , id = "gui-U7cDpbx3GSc" },
  ...
  ["The Candle King"] = {
    ...
    entries = {
      ...
      { role = "ALL", text = "Use s:Darkflame: (5y circle) to destroy multiple statues.", type = "Call", id = "gui-w8kJTStFdJ0" },
      ...
      { role = "TANK", text = "Play relatively close together to cluster the wax statues, we are rotating counter-clockwise.", type = "Call", id = "gui-c0YrN4VlkB8" },
