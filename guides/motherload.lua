DungeonGuide_Guides["The MOTHERLODE!!"] = {
  ...
  ["Route"] = {
    ...
    ALL = {
      { text = "Up to first Mechanized Peacekeeper. Stay RIGHT. Kill Mech Jockeys + Assassins first.", type = "Call" },
      { text = "Single pull: Mechanized Peacekeeper next. Watch Tear Gas.", type = "Call" },
      { text = "After Peacekeeper, going left WITHOUT skips.", type = "Call" },
      { text = "Addled Thug + Mech Jockey + Vendor + Mechanized Peacekeeper. Stop Mech Jockey from mounting.", type = "Call" },
      { text = "Next pull: Heading straight into Addled Thug + Assassin + Mech Jockey then right into Mech Jockey + Vendor.", type = "Call" },
      ...
      { text = "Post-Pummeler pull Extractor + Sapper + Rats back here. Then hug right side", type = "Call" },
      { text = "Big pull: Extractor + Earthshaper + Rats into Earthshaper + Sapper + Rats. *Stay right*.", type = "Call" },
      { text = "Move up hill. Extractor + 2x Earthshaper + 2x Earthshaper. Go down hill to avoid swirlies", type = "Call" },
      { text = "After these pull 2x Stonefuries + Shale Biters together.", type = "Call" },
      { text = "Target Taskmaster Askari then pull trash into boss.", type = "Call" },
      { text = "Pulling trash into Azerokk boss.", type = "Call" },
      { text = "After Azerokk, go centre. Be carful - lots around. Alchemist + Mastermind + Test Subject", type = "Call" },
      { text = "3x Alchemists. Stay tight, lots around.", type = "Call" },
