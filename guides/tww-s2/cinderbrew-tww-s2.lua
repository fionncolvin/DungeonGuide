DungeonGuide_Guides["dung-cinderbrew-tww-s2"] = {
  ...
  ["Route"] = {
    ...
    header = "Route",
    entries = {
      { order = 1, role = "ALL", text = "Pulling right side to start. Watch n[Chef Chewie] patrol.", type = "Call", id = "gui-dYXpsLEOfhY" },
      { order = 2, role = "ALL", text = "Only one n[Hired Muscle] at a time. No double pulls.", type = "Call", id = "gui-KRUfvCWWHjs" },
      { order = 3, role = "ALL", text = "Pulling far-right n[Pyromaniac], n[Patrons], and n[Hired Muscle] first.", type = "Call", id = "gui-RX7G1vQC3E" },
      { order = 4, role = "ALL", text = "If n[Attendant] is close, cleave it with first pull.", type = "Call", id = "gui-1T8cqeT1kms" },
      { order = 5, role = "ALL", text = "Pop Lust early while burning first pull cooldowns.", type = "Call", id = "gui-yudXF5OMvR0" },
      { order = 6, role = "ALL", text = "Wait for safe patrol before pulling n[Chef Chewie].", type = "Call", id = "gui-wTZxBYmQwzY" },
      { order = 7, role = "ALL", text = "After n[Chewie], pull n[Hired Muscle] + nearby trash carefully.", type = "Mechanic", id = "gui-Qg36b8vGkaI" },
      { order = 8, role = "ALL", text = "Skip deep corner pack. Not needed for count.", type = "Call", id = "gui-14VPxtAPvhA" },
      { order = 9, role = "ALL", text = "Boss Fight: Brew Master Aldryr", type = "Jump", target="Brew Master Aldryr", id = "gui-qrTpJ1nlv6Y" },
      { order = 10, role = "ALL", text = "Heading north after first boss. Fighting n[I'pa] next.", type = "Call", id = "gui-09oMKiq4xDo" },
      { order = 11, role = "ALL", text = "One pack at a time here. Will struggle otherwise.", type = "Call", id = "gui-OZ3CMpuCz4" },
      { order = 12, role = "ALL", text = "Focus n[Flavor Scientists] for interrupts. Watch n[Hop Goblins].", type = "Mechanic", id = "gui-UdIZDrYzJLY" },
      { order = 13, role = "ALL", text = "Pull n[Careless Hop Goblin] first on n[I'pa] platform.", type = "Call", id = "gui-rLGTc97ific" },
      { order = 14, role = "ALL", text = "Pull packs out into hallway to avoid double patrols.", type = "Call", id = "gui-19qKniIUhRg" },
      { order = 15, role = "ALL", text = "Boss Fight: I'pa", type = "Jump", target="I'pa", id = "gui-kJsnWPhT1L8" },
      { order = 16, role = "ALL", text = "After n[I'pa], move south to n[Buzzbee] wing.", type = "Call", id = "gui-YkUKTRbDJn0" },
      { order = 17, role = "ALL", text = "Pulling three Bee packs carefully. Watch for Sting casts.", type = "Call", id = "gui-6fH1uBctns" },
      { order = 18, role = "ALL", text = "Pull corner n[Purveyor] with Worker Bees. Manage puddles.", type = "Call", id = "gui-lw2c6gcVwzY" },
      { order = 19, role = "ALL", text = "Do not pull more than two n[Purveyors] at once.", type = "Call", id = "gui-awXHeVGqFDs" },
      { order = 20, role = "ALL", text = "Try skipping the n[Purveyor] near boss room entrance.", type = "Call", id = "gui-LDUWOgY5v2o" },
      { order = 21, role = "ALL", text = "Clear most Beelets before n[Buzzbee] fight. Pull a few into boss if clean.", type = "Call", id = "gui-aht9PHmTTV4" },
      { order = 22, role = "ALL", text = "Boss Fight: Benk Buzzbee", type = "Jump", target="Benk Buzzbee", id = "gui-yJEMc6kHafQ" },
      { order = 23, role = "ALL", text = "After n[Buzzbee], small pulls to n[Goldie]. Trash gives low count.", type = "Mechanic", id = "gui-mvz3gnioQ" },
      { order = 24, role = "ALL", text = "Boss Fight: Goldie Baronbottom", type = "Jump", target="Goldie Baronbottom", id = "gui-B7d85iTmTI" }
    },
  },
