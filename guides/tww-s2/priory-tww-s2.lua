DungeonGuide_Guides["dung-priory-tww-s2"] = {
  ...
  ["Route"] = {
    ...
    header = "Route",
    entries = {
      { order = 1, role = "ALL", text = "Big pull to start with Footmen into Patrol into 2x packs at Fountain. Bloodlust here.", type = "Call", id = "gui-0ZUDctANAM" },
      { order = 2, role = "ALL", text = "Pull Guard Captain Suleyman next. Position on LEFT stairs for Shield Slam.", type = "Call", id = "gui-VDcccYRj40" },
      { order = 3, role = "ALL", text = "Up the stairs for Sergeant Shaynemail when she runs in + RIGHT pack. Avoiding the Sharpshooter on the left.", type = "Call", id = "gui-ejGDVcwCxkk" },
      { order = 4, role = "ALL", text = "Patrol + tree-side 3-pack next.", type = "Call", id = "gui-F9R9hLVlv5Y" },
      { order = 5, role = "ALL", text = "Chain Conjurers + Lightspawn + Neophytes. Respect tank damage.", type = "Call", id = "gui-MnlZWUHUzcI" },
      { order = 6, role = "ALL", text = "Pull High Priest Aemya next. Focus interrupts.", type = "Call", id = "gui-MQAL7MQgUAA" },
      { order = 7, role = "ALL", text = "Move to catch Duelmal mid-run if possible.", type = "Call", id = "gui-H21rgows7o0" },
      { order = 8, role = "ALL", text = "Fight Captain Dailcry next. South-side mini-boss preferred for cleave.", type = "Call", id = "gui-3zUbNMY4028" },
      { order = 9, role = "ALL", text = "Boss Fight: Captain Dailcry", type = "Jump", target="Captain Dailcry", id = "gui-ZaJqCQUABo" },
      { order = 10, role = "ALL", text = "Full pull Cathedral Neophytes first. Watch Sacred Toll casts.", type = "Call", id = "gui-jXmN4Q6M0M8" },
      { order = 11, role = "ALL", text = "Clear left side first in Cathedral. Then right side.", type = "Call", id = "gui-KDwAtsh4jo" },
      { order = 12, role = "ALL", text = "Boss Fight: Baron Braunpyke", type = "Jump", target="Baron Braunpyke", id = "gui-Gd38CTRtNE" },
      { order = 13, role = "ALL", text = "After Braunpyke, pull double Paladins, Priests, and Templars.", type = "Call", id = "gui-fDSwCOfbQik" },
      { order = 14, role = "ALL", text = "LOS first stairwell pack into stairwell for safe pull.", type = "Call", id = "gui-DirUdAp0Dqk" },
      { order = 15, role = "ALL", text = "Focus Lightspawns carefully. Avoid healing mobs with Purification zones.", type = "Call", id = "gui-0QkODqd4Ys4" },
      { order = 16, role = "ALL", text = "Clear right side first or patrol depending on timing.", type = "Call", id = "gui-15IL321Md1Q" },
      { order = 17, role = "ALL", text = "Middle group last. Must clear both sides of steps as they pull-in with boss.", type = "Call", id = "gui-xBGxx7kpEs" },
      { order = 18, role = "ALL", text = "Final boss: Prioress Murrpray after full clear.", type = "Call", id = "gui-QZUfmC1JE" },
      { order = 19, role = "ALL", text = "Boss Fight: Prioress Murrpray", type = "Jump", target="Prioress Murrpray", id = "gui-CWa5AzFNxwM" }
    },
  },
