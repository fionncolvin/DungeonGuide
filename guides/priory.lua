DungeonGuide_Guides["Priory of the Sacred Flame"] = {
  ...
  ["Priory of the Sacred Flame"] = {
    ...
    entries = {
      ...
      { order = 4, role = "ALL", text = "Kill Risen Mages/Footmen staggered â€” death AoE heals allies via Light Expulsion.", type = "Mechanic", id = "gui-IZ4lXRY2ys" },
      ...
      { order = 8, role = "ALL", text = "Some trash pulls have chain interrupts and high AoE â€” pre-assign kicks.", type = "Mechanic", id = "gui-DsSywAWLVPo" },
      ...
      { order = 11, role = "TANK", text = "Taunt Trusted Guard (Captain Dailcry) instantly. Donâ€™t let it melee others.", type = "Mechanic", id = "gui-MDgdiC419w" },
      ...
      { order = 14, role = "DPS", text = "Save cooldowns for Murrpray intermission shield â€” faster break = fewer add waves.", type = "Mechanic", id = "gui-LJjhkqAzwHQ" },
  ...
  ["Captain Dailcry"] = {
    ...
    entries = {
      ...
      { order = 2, role = "ALL", text = "Kick Battle Cry â€” group damage + Trusted Guard gets enraged.", type = "Interrupt", id = "gui-YV1GVLmqD4" },
      { order = 3, role = "ALL", text = "Dodge Hurl Spear â€” line attack applies bleed to all hit.", type = "Mechanic", id = "gui-aEyJA0UiFA" },
      { order = 4, role = "ALL", text = "Savage Mauling incoming â€” burn absorb to stop the channel.", type = "Call", id = "gui-eoZO2tTUQaw" },
      { order = 5, role = "ALL", text = "Trusted Guard shares HP â€” cleave but donâ€™t focus.", type = "Mechanic", id = "gui-mrNhZ3t42uo" },
      { order = 6, role = "TANK", text = "Use major for Pierce Armor â€” big hit + stacking bleed.", type = "Mechanic", id = "gui-CK9pMeUDTYQ" },
      ...
      { order = 9, role = "TANK", text = "Reposition out of swirlies from Guardâ€™s Emberstorm if active.", type = "Mechanic", id = "gui-1xPG2G2iDNY" },
      { order = 10, role = "TANK", text = "Mitigate Pierce + Mauling overlap â€” high physical burst.", type = "Mechanic", id = "gui-k5RRIMwggo" },
  ...
  ["Baron Braunpyke"] = {
    ...
    entries = {
      { order = 1, role = "ALL", text = "Vindictive Wrath active â€” all boss abilities are stronger. Play safe.", type = "Call", id = "gui-lQUg69I0rz8" },
      ...
      { order = 4, role = "ALL", text = "Sacrificial Pyre: Soak 3x (5x if empowered). Rotate soakers, donâ€™t overstack.", type = "Mechanic", id = "gui-RscBFbvu75s" },
      { order = 5, role = "ALL", text = "Use immunities to soak Pyres safely â€” avoid excessive DoT stacks.", type = "Mechanic", id = "gui-Zw5wuFzD0GQ" },
      { order = 6, role = "TANK", text = "Pull boss to room edge to bait hammers safely.", type = "Position", id = "gui-eM8RoOCiNJQ" },
      { order = 7, role = "TANK", text = "Soak 2x Sacrificial Pyres with defensive â€” announce timing.", type = "Mechanic", id = "gui-iPFjC9QzOm4" },
      ...
      { order = 10, role = "HEALER", text = "Watch Sacrificial Flame DoT stacks â€” heal soakers immediately.", type = "Mechanic", id = "gui-tSsR27tXMwI" },
      { order = 11, role = "DPS", text = "Stack with group for Hammer baits. Donâ€™t panic spread.", type = "Mechanic", id = "gui-UkjDZFB7z8E" },
      { order = 12, role = "DPS", text = "Rotate Pyre soaks smartly â€” avoid doubling up or early clears.", type = "Mechanic", id = "gui-OdoqP2w4r64" }
    },
  },
  ...
  ["Prioress Murrpray"] = {
    ...
    entries = {
      { order = 1, role = "ALL", text = "Holy Flame puddle â€” move ASAP to avoid DoT + flames.", type = "Mechanic", id = "gui-nGxKbznuGbQ" },
      { order = 2, role = "ALL", text = "Turn away before Blinding Light cast finishes or be disoriented.", type = "Mechanic", id = "gui-bKVoYnUrbSo" },
      { order = 3, role = "ALL", text = "Interrupt Holy Smite â€” high tank + group damage.", type = "Interrupt", id = "gui-ufY2U8htLEQ" },
      ...
      { order = 8, role = "TANK", text = "Grab adds as they reach the platform â€” they melee and pulse.", type = "Mechanic", id = "gui-lIdXIYqAdhM" },
      { order = 9, role = "TANK", text = "Help burst shield with offensive cooldowns.", type = "Call", id = "gui-IhNLY9CwQMs" },
      { order = 10, role = "HEALER", text = "CDs for Inner Fire + Blinding Light overlap â€” heavy AoE.", type = "Call", id = "gui-g4mpRvyuIQ" },
      { order = 11, role = "HEALER", text = "Heal through Embrace the Light channel â€” it pulses until broken.", type = "Mechanic", id = "gui-oR8NQhYPgrU" },
